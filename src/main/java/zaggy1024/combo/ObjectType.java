...
import zaggy1024.combo.variant.IVariant;
import zaggy1024.item.ItemBlockMulti;
import zaggy1024.item.ItemMulti;
import zaggy1024.util.FlexibleStateMap;
import zaggy1024.util.ReflectionUtils;
import zaggy1024.util.StreamUtils;
...
public class ObjectType<V extends IMetadata<V>, B extends Block, I extends Item> implements IVariant {
    ...
    public ObjectType<V, B, I> setTranslationKey(String unlocName) {
