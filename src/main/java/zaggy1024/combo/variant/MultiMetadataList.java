...
import zaggy1024.combo.variant.MultiMetadataList.MultiMetadata;
...
public class MultiMetadataList implements List<MultiMetadata> {
    ...
    public class MultiMetadata implements IMetadata<MultiMetadata> {
        ...
        public String getTranslationKey() {
            return variant.getTranslationKey();
        }
        ...
        @Override
        public int compareTo(MultiMetadata o) {
    ...
    @Override
    public Iterator<MultiMetadata> iterator() {
    ...
    @Override
    public boolean add(MultiMetadata e) {
    ...
    public boolean containsAll(Collection<?> c) {
        return variants.containsAll(c);
    }

    @Override
    public boolean addAll(Collection<? extends MultiMetadata> c) {
        return variants.addAll(c);
    }

    @Override
    public boolean addAll(int index, Collection<? extends MultiMetadata> c) {
    ...
    @Override
    public MultiMetadata get(int index) {
        return variants.get(index);
    }

    @Override
    public MultiMetadata set(int index, MultiMetadata element) {
        return variants.set(index, element);
    }

    @Override
    public void add(int index, MultiMetadata element) {
        variants.add(index, element);
    }

    @Override
    public MultiMetadata remove(int index) {
    ...
    public int lastIndexOf(Object o) {
        return variants.lastIndexOf(o);
    }

    @Override
    public ListIterator<MultiMetadata> listIterator() {
        return variants.listIterator();
    }

    @Override
    public ListIterator<MultiMetadata> listIterator(int index) {
        return variants.listIterator(index);
    }

    @Override
    public List<MultiMetadata> subList(int fromIndex, int toIndex) {
        return variants.subList(fromIndex, toIndex);
    }
}
