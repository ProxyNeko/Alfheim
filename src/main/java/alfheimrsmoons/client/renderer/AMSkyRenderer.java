...
public class AMSkyRenderer extends IRenderHandler {

    private static final ResourceLocation AM_SKY_TEXTURES = new ResourceLocation(AlfheimrsMoons.MOD_ID, "textures/world/alfheimr_sky.png");
    private static final ResourceLocation VANILLA_SUN = new ResourceLocation("textures/environment/sun.png");

    //Modified version of RenderGlobal.renderSkyEnd()
    @Override
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        mc.getTextureManager().bindTexture(AM_SKY_TEXTURES);
